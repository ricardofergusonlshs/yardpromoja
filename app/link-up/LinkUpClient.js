  ...
  return (
    <div className="yp-linkup-page">
      ...
      <section className="yp-linkup-section">
        <div className="yp-container yp-linkup-featured-grid">
          <div className="yp-dark-card yp-linkup-featured">
            ...
            {loading ? (
              ...
              <div className="yp-featured-event">
                <div className="yp-featured-poster-wrap">
      ...
      <section className="yp-linkup-section">
        <div className="yp-container yp-linkup-main-grid">
            ...
            <div className="yp-linkup-plan-rows">
              {planRows.map((row) => (
                <div className={`yp-linkup-plan-row ${row.color}`} key={row.id}>
                  ...
                  <span className="yp-row-count" aria-label={`${row.items.length} options found`}>
                    {row.items.length}
                  </span>
          ...
          <aside className="yp-linkup-sidebar">
            <div className="yp-dark-card yp-linkup-side-card">
            ...
            <div className="yp-dark-card yp-linkup-side-card yp-deals-card">
      ...
      <section className="yp-linkup-section">
        <div className="yp-container yp-dark-card yp-linkup-share">
          <div>
      ...
      <section className="yp-linkup-section yp-linkup-final-section">
        <div className="yp-container yp-linkup-bottom-cta">
          <Link href="/create">
            <em>📣</em>
          ...
          <Link href="/advertise">
            ...
            <span>Promote your business to thousands of Jamaicans daily.</span>
            <b>Learn More</b>
          </Link>
          <Link href="/contact">
            <em>🎧</em>
            <strong>Need Help?</strong>
            <span>We’re here for you. Contact our team.</span>
            <b>Contact Us</b>
          </Link>
        </div>
      </section>
